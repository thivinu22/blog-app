  ...
  return (
    <div>
      <form onSubmit={onSubmitHandler} className='pt-5 px-5 sm:pt-12 sm:pl-16' action="">
          ...
          <p className='text-xl mt-4'>Blog Titile</p>
          ...
          <textarea type="text" name='description' onChange={onChangeHandler} value={data.description} placeholder='Write content here' rows={6} required className='w-full sm:w-[500px] mt-4 px-4 py-3 border'/>
